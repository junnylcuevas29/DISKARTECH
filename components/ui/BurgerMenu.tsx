...
import { getFullName, registerStudentData } from '@/data/studentProfile';
        ...
        <Animated.View style={[styles.drawer, { transform: [{ translateX }] }]}>
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                onClose();
                setTimeout(() => router.push('/student/(tabs)/profile'), 250);
              }}
            >
              <Avatar
                uri={registerStudentData.hasProfilePicture ? 'https://ui-avatars.com/api/?name=Junnyl+Mabini&background=D32F2F&color=fff&size=200' : undefined}
                name={getFullName(registerStudentData)}
                size={56}
                verified={registerStudentData.verificationStatus === 'verified'}
              />
              <View style={styles.userInfo}>
                <Text style={styles.userName}>{getFullName(registerStudentData)}</Text>
                <Text style={styles.userEmail}>{registerStudentData.email}</Text>
              </View>
            </TouchableOpacity>
          </View>
